...
- TOPIARYAUTOMATIONCOMPONENT e.g. TOPIARYAUTOMATIONCOMPONENT 
...
TOPIARYAUTOMATIONCOMPONENT::TOPIARYAUTOMATIONCOMPONENT()
...
void TOPIARYAUTOMATIONCOMPONENT::setModel(TOPIARYMODEL* m)
{
	model = m;
...
void TOPIARYAUTOMATIONCOMPONENT::paint(Graphics& g)
{
...
void TOPIARYAUTOMATIONCOMPONENT::resized()
{
} //resized

/////////////////////////////////////////////////////////////////////////

void TOPIARYAUTOMATIONCOMPONENT::actionListenerCallback(const String &message)
{
...
void TOPIARYAUTOMATIONCOMPONENT::getVariationControl()
{
	// get data from model
	bool ccSwitching;
	int channel;
...
void TOPIARYAUTOMATIONCOMPONENT::setVariationControl()
{
	// write data to model
